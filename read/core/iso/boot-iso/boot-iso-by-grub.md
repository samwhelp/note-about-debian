...
將「ISO檔案」放到「/opt/iso/debian/12/debian-live-12.6.0-amd64-xfce.iso」這個路徑。

舉例執行下面指令

``` sh
sudo curl -fLo /opt/iso/debian/12/debian-live-12.6.0-amd64-xfce.iso --create-dirs \
...
menuentry "Debian 12 ISO / Xfce" --class Debian {
	set iso_file="/opt/iso/debian/12/debian-live-12.6.0-amd64-xfce.iso"
